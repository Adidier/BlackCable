...
void CubeModel::Draw()
{
	...
	angle += 0.001f;
	transform.setTranslate(1.0f, 1.0f, -2.0f);
	transform.setScale(1.0f, 1.0f, 1.0f);
	transform.setRotate(angle, angle, 0.0f);
	glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(transform.setTransformMat4()));
	texture->UseTexture();
