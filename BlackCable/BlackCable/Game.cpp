...
#pragma region Carga de Modelos
	...
	//Carga de modelos de las cajas, aqu� inician
...
void Game::Update()
{
	...
	for(auto enemy : enemyPool)
	{
		...
		glm::vec3 playerVec = player->GetPlayerPosition();	//Guarda la posici�n del jugador
		glm::vec3 enemyVec = enemy->GetPosition();			//Guarda la posici�n del enemigo
